...
*& ZPP_MODBOM (ZPP_MODBOM-ZFLAG1 = X e ZPP_MODBOM-ZFLAG2 = SPACE)
*& alimenta direttamente le tabelle ZPP_PDM_MON_ANAG e ZPP_PDM_MON_BOM per
*& il Cruscotto Produzione (Step 2).
*& Allo scopo utilizzerà la tabella di riepilogo ZPP_PDM_NOR_BOM (Step 1)
